...
// Get all online students for a teacher
const getOnlineStudents = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // // Get teacher's students from groups
        // const teacher = await Teacher.findOne({ user: req.user._id });
        // if (!teacher) {
        //     res.status(404).json({ message: 'Teacher not found' });
        //     return;
        // }
        // Get all online users with 'student' role
        const onlineUsers = (0, websocketService_1.getOnlineUsers)('student');
        // Get user details for online students (userId is actually student ID)
